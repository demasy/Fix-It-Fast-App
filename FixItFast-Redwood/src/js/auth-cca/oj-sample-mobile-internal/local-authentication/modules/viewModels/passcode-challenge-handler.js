...
define(['ojs/ojanimation', 'knockout',
  ...
  function(AnimationUtils, ko) {
    ...
    PasscodeChallengeModel.prototype.hide = function(id) {
      this.getById(id).classList.remove('demo-display-block');
      return this.getById(id).classList.add('demo-display-none');
    };
    ...
    PasscodeChallengeModel.prototype.show = function(id) {
      this.getById(id).classList.remove('demo-display-none');
      return this.getById(id).classList.add('demo-display-block');
    };
